...
for ac in asicsConfig.values():
        ...
        #ac.channelConfig[targetChannel].setValue("trigger_mode_1", 0b01)
	...
	ac.channelConfig[targetChannel].setValue("trigger_mode_2_b", 0b00)
        ac.channelConfig[targetChannel].setValue("vth_t1", 63)
        ac.channelConfig[targetChannel].printAllValues()
